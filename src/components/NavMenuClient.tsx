  ...
  return (
    <div className="flex-grow h-full my-auto relative w-fit">
      <div className="block -mt-3 text-5xl w-full z-50 lg:hidden">
        <FontAwesomeIcon
          icon={faBars}
          className={`absolute cursor-pointer duration-300 transform transition-opacity  ${
      ...
      >
        ...
        <NavLink title={translations.Projects} icon={faLaptopCode} route="/projects" />
        <NavLink title={translations.Tech} icon={faGear} route="/tech" />
        <NavLink title={translations.About} icon={faUserSecret} route="/about" />
      </div>
    </div>
  );
}
